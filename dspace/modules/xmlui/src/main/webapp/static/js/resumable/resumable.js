...
"use strict";
  ...
  var Resumable = function(opts){
      ...
      $h.each(fileList, function(file){
        ...
        function addFile(uniqueIdentifier){
          if (!$.getFromUniqueIdentifier(uniqueIdentifier)) {(function(){
            ...
            // needs the id of the item this file is attached to
            var f = new ResumableFile($, file, uniqueIdentifier, null);
            $.files.push(f);
            files.push(f);
    ...
    function ResumableFile(resumableObj, file, uniqueIdentifier, itemID){
      var $ = this;
      $.opts = {};
