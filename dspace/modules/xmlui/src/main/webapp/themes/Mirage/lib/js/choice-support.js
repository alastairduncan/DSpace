...
//                debugger;
                ...
                var extraMetadata = [];
                extraMetadata.projectTitle = current.attr("title");
                extraMetadata.projectUrl = current.attr("url");
                extraMetadata.authorityId = current.attr("authority");
                extraMetadata.value = current.attr("value");
