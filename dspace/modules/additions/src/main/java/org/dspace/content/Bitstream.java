...
public class Bitstream extends DSpaceObject
{
     ...
     * @throws SQLException
     */
    static Bitstream createBig(Context context, String bitstreamId, int itemID)
            throws IOException, SQLException
    {
    	
    	log.info("createBig bitstream_id=" + bitstreamId);
        // Store the bits
        int bstreamid = BigFileBitstreamStorage.store(context, bitstreamId, itemID);
        ...
        context.addEvent(new Event(Event.CREATE, Constants.BITSTREAM, 
        		bstreamid, null, bitstream.getIdentifiers(context)));
